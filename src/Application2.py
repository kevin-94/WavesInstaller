...
config["kafka"]=unicode("https://www.apache.org/dyn/closer.cgi?path=/kafka/0.10.0.0/kafka-0.10.0.0-src.tgz")
config["storm"]=unicode("http://www.apache.org/dyn/closer.lua/storm/apache-storm-1.0.1/apache-storm-1.0.1.tar.gz")
config["grafana"]=unicode("https://grafanarel.s3.amazonaws.com/builds/grafana_3.0.4-1464167696_amd64.deb")
config["influx"]=unicode(" https://dl.influxdata.com/influxdb/releases/influxdb_0.13.0_amd64.deb")
...
class SecWindow(QtGui.QWidget):
    ...
    # Position
        ...
        posit.addWidget(self.download, 9,10)
        posit.addWidget(self.cancel,10,10)
